      ...
      <div className="backdrop-blur-sm bg-transparent dark:bg-zinc-800 dark:border-zinc-600 p-1 sm:p-5 md:p-12 md:max-w-[90%]">
        ...
        {/* <div className='flex flex-row gap-5 items-center'> */}
          ...
          <Link href='/workspace/new'>
            <div className="text-xs bg-gradient-to-r from-secondary to-primary p-2 px-4 rounded-lg md:text-base text-white hover:opacity-65 focus:outline-none flex items-center justify-start mt-10">
